...
add_library(mediaproxy_http STATIC
    ...
    src/http/dns_resolver.cpp
    src/http/event.cpp
    src/http/idna.cpp
    src/http/origin_curl.cpp
    src/http/origin_download.cpp
...
if(BUILD_TESTING)
    ...
    add_executable(mediaproxy_http_test
        ...
        tests/http/dns_resolver_test.cpp
    ...
    add_executable(mediaproxy_runtime_test
        tests/runtime/client_test.cpp
        tests/runtime/deadline_test.cpp
        tests/runtime/invocation_test.cpp
        tests/runtime/next_response_test.cpp
        tests/runtime/socket_transport_test.cpp
